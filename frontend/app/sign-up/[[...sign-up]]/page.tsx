  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md text-center">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">SocialDoctors 시작하기</h1>
          <p className="text-gray-500 text-sm">Google 계정으로 무료로 시작하세요</p>
        </div>
        <button
          onClick={() => signIn('google', { callbackUrl: '/' })}
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-primary-600 hover:bg-primary-700 rounded-xl font-semibold text-white transition-all duration-200 shadow-md hover:shadow-lg"
        >
        ...
        <p className="mt-4 text-sm text-gray-500">
          이미 계정이 있으신가요?{' '}
          <a href="/sign-in" className="text-primary-600 hover:underline font-medium">
            로그인
          </a>
        </p>
